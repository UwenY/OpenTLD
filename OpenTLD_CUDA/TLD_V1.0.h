...
public:
	...
	void init_v(const Mat& FirstFrame, const Rect& box);
	...
	void processFrame(const Mat& CurrFrame_con_cvM, const Mat& NextFrame_con_cvM, BoundingBox& Nextbb, bool& lastboxFound);
